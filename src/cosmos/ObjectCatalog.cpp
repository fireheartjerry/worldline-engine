...
std::vector<UniverseObject> build_object_catalog() {
    ...
    add("helium3", "Helium-3 nucleus", "3He", Scale::NUCLEAR, 5.008e-27, 2.0, 1.7e-15,
        "Light helium isotope; one neutron short of an alpha.",
    ...
    add("uranium238_nucleus", "Uranium-238 nucleus", "238U", Scale::NUCLEAR, 3.953e-25, 92.0, 7.4e-15,
        "Heavy fissile-chain nucleus.");
    ...
    add("chlorine", "Chlorine", "Cl", Scale::ATOMIC, 5.887e-26, 0.0, 7.9e-11,
        "Reactive halogen.");
    ...
    add("methanol", "Methanol", "CH3OH", Scale::MOLECULAR, 5.32e-26, 0.0, 4.1e-10,
        "Simplest alcohol; abundant in molecular clouds.",
    ...
    add("neptune", "Neptune", "Nep", Scale::PLANETARY, 1.024e26, 0.0, 2.46e7,
        "Windy ice giant.");
    add("saturn", "Saturn", "Sat", Scale::PLANETARY, 5.683e26, 0.0, 5.82e7,
        "Ringed gas giant.");
    ...
    add("intermediate_black_hole", "Intermediate black hole", "IMBH", Scale::STELLAR, 2.0e33, 0.0, 3.0e6,
        "Thousand-solar-mass black hole in a dense cluster.");
    add("supermassive_black_hole", "Supermassive black hole", "SMBH", Scale::STELLAR, 8.5e36, 0.0, 1.27e10,
        "Galactic-center giant (e.g. Sgr A*).");
